...
// class PokemonClientListHttpMockito extends Mock
//     implements PokemonListRepository {}

// class DioMock extends Mock implements IRestClient {}
...
//   @override
//   Future<PokemonModel> getPokemons(_) async {
//     return PokemonModel(
//         id: 1,
//         name: "Bulbasaur",
//         sprite: "Bulbasaur",
...
// class PokeListMock implements PokemonListRepository {
//   @override
//   IRestClient get client => throw UnimplementedError();

//   @override
//   Future<PokemonListModel> getAllPokemons(String page) async {
//     return PokemonListModel(count: 1, next: "", previous: "", results: []);
//   }
// }

// void main() {
//   final pokemon = PokemonClientHttpMockito();
//   final list = PokemonClientListHttpMockito();

//   final realApiPokemonDetails = PokemonRepository(DioClient.withAuthBasic());
//   final realApiPokemonList = PokemonListRepository(DioClient.withAuthBasic());

//   final realTestviewModel =
//       PokemonViewModel(realApiPokemonDetails, realApiPokemonList);
//   group("Testes ViewModel Pokemon", () {
//     test('viewModel list of pokemon', () async {
//       final viewModel = PokemonViewModel(
//         PokemonClientHttpMockito(),
//         PokemonClientListHttpMockito(),
//       );

//       await viewModel.fetchAll();
//       expect(viewModel.listAllPokemon, isA<List<PokemonModel>>());
//     });
//     test('viewModel list of pokemon empty', () async {
//       final viewModel = PokemonViewModel(
//         PokemonClientHttpMockito(),
//         PokemonClientListHttpMockito(),
//       );
...
//       await viewModel.fetchAll();
//       expect(viewModel.listAllPokemon, []);
//     });

//     test('viewModel list of pokemon isNotEmpty', () async {
//       final viewModel = PokemonViewModel(
//         PokemonClientHttpMockito(),
//         PokemonClientListHttpMockito(),
//       );
...
//       await viewModel.fetchAll();
//       expect(viewModel.listAllPokemon.isNotEmpty, false);
//     });
//     test('viewModel list of pokemon name = null', () async {
//       final viewModel = PokemonViewModel(
//         PokemonClientHttpMockito(),
//         PokemonClientListHttpMockito(),
//       );
...
//       await viewModel.fetchAll();
//       expect(viewModel.pokemonModel.name, null);
//     });
//     test('viewModel list of pokemon result = null ', () async {
//       final viewModel = PokemonViewModel(
//         pokemon,
//         list,
//       );
//       await viewModel.fetchAll();
//       expect(viewModel.pokemomListCount.results, null);
//     });
//     test('viewModel list of pokemon real name = bulbasaur ', () async {
//       await realTestviewModel.fetchAll();
//       expect(realTestviewModel.listAllPokemon[0].name, "bulbasaur");
//     });
//   });
// }
